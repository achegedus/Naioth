module Authlogic
  ...
  #
  #   class User.rb < ActiveRecord::Base
  ...
  module AuthenticatesMany
    module Base
      ...
      #   This is the name of the relationship you want to use to scope everything. For example an User.rb has many Users. There should be a relationship
